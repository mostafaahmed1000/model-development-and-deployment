...
class SQLRepository:
    ...
    def insert_table(self, table_name, records, if_exists="fail"):
        ...
        """
        records_inserted = records.to_sql(name=table_name, con=self.connection, if_exists=if_exists)
        
        return {"transaction_successful": True,  "records_inserted": records_inserted}
    ...
    def read_table(self, table_name, limit=None):
        ...
        if limit:
            sql = sql = f"SELECT * FROM '{table_name}' LIMIT {limit}"
        else:
